...
export default function VersionModal({ onClose }: { onClose: () => void }) {
  return (
    <div
      className="fixed bottom-0 top-0 left-0 right-0 bg-black/30"
      onClick={onClose}
    >
      <div className="fixed flex items-center justify-center bg-themered-500 shadow-evenInset top-20 left-20 right-20 bottom-20 rounded-3xl py-5 px-2">
        <Close
          className="left-6 top-6 w-8 h-8 cursor-pointer absolute bg-red-950/50 rounded-full p-1"
          onClick={onClose}
        />
        <div
        ...
        >
          ...
          <p className="text-red-200 text-center">
            This is an early version of the site; expect occasional bugs. Please
