...
function DateSelector({ dates }: Props) {
  ...
  return (
    <>
      <div className="bg-themered-500 grid grid-cols-5 grow shadow-[inset_0_0px_4px_0_rgba(0,0,0,0.5)] text-xl font-medium text-themered-100 divide-x-2 divide-themered-200/50">
        {dates.map((date) => (
          <Fragment key={date}>
            <span
